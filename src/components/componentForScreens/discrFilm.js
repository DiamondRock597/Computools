...
export const DiscrFilm = ({ route }) => {
    ...
    return (
        <ScrollView style={{ backgroundColor: '#898996', opacity: 0.9, height: '100%' }}>
            <View style={styles.container}>
                ...
                <View style={styles.textRatingBlock}>
                    <Icon onPress={()=>(setFavourite(!favourite))} name={favourite?'star':'star-o'}  size={30} color='yellow'/>
            ...
            <View style={{ justifyContent: 'center' }}>
                <View >
                    <Text style={styles.name}>
                        {film.original_title}
                            ({releaseData.toDateString().slice(-4)})
                        </Text>
                </View>
                <View>
